...
Date: 18/8/2025
This is components.py module.
Usage:
- This module is used to define the TFX pipeline components.
- It includes the initialization of various components such as ExampleGen, StatisticsGen, SchemaGen, 
  ExampleValidator, Transform, Tuner, Trainer, Evaluator, and Pusher.
"""
...
def init_components(data_dir,
    ...
    eval_config = tfma.EvalConfig(
        model_specs=[tfma.ModelSpec(label_key='Personality')],
